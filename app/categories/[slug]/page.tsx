...
export default async function CategoryDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const faqs = [
    { question: `How do I choose the right ${category.name.toLowerCase()}?`, answer: "Start with available space, expected users, training goals, daily usage and budget. Our team can help shortlist suitable configurations." },
    { question: `Can I request a quote for ${category.name.toLowerCase()}?`, answer: "Yes. Submit the category enquiry form with your quantity, space and preferred equipment details." },
    { question: `Is ${category.name.toLowerCase()} suitable for home or commercial use?`, answer: "Suitability depends on the equipment type, usage level, space and user profile. Span Fitness can help compare practical home and commercial options." },
    { question: `Can you suggest products under ${category.name.toLowerCase()}?`, answer: "Yes. Share your goal, floor area and budget range so the team can suggest relevant products or alternatives from the current range." },
  ];
