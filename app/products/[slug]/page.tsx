...
export default async function ProductDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const faqs = [
    ...
    { question: `Is ${product.name} suitable for home and commercial use?`, answer: "Suitability depends on the product type, usage frequency, available space and expected users. The team can suggest the right option for your requirement." },
    { question: `Can I request a quote for ${product.name}?`, answer: "Yes. Use the product enquiry form, WhatsApp enquiry button or call Span Fitness Equipments to request current pricing and availability details." }
  ];
  const productSchema = {
